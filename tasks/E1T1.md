# E1T1 — /convert command with validation and conversion

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CVB

Implement the /convert command handler in src/handlers/convert.ts. Validate input arguments, perform unit conversions using category-specific formulas, and return results rounded to 6 significant digits. Write tests to tests/specs/convert.json and register the command in tests/commands/convert.json.
