# E3T1 — Redis storage for favorites

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CVB

Implement Redis integration in src/handlers/redis-favs.ts to store and retrieve user favorites as '<from>:<to>' strings in Redis sets. Enforce per-user limits and key patterns.
