# E2T2 — /favs command with Redis retrieval

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CVB

Implement the /favs command handler in src/handlers/favs.ts. Retrieve and format the user's saved favorites from Redis, handling empty states. Write tests to tests/specs/favs.json and register the command in tests/commands/favs.json.
